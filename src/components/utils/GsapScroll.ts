...
export function setCharTimeline(
  ...
  if (window.innerWidth > 1024 && character) {
    ...
    tl2
      ...
      .fromTo(".character-model", { pointerEvents: "inherit" }, { pointerEvents: "none", xPercent: -12, delay: 2, duration: 5 }, 0)
    ...
    tl3
      .fromTo(".character-model", { yPercent: 0 }, { yPercent: -100, duration: 4, ease: "none", delay: 1 }, 0)
...
export function setAllTimeline() {
  const careerTimeline = gsap.timeline({
    scrollTrigger: { trigger: ".career-section", start: "top 30%", end: "100% center", scrub: true, invalidateOnRefresh: true },
  });
  careerTimeline
